...
class SmartHomeSimulator:
    ...
    def process_command(self, cmd):
        ...
        elif cmd == "LIGHT_BEDROOM_ON":
            self.devices["light_bedroom"] = "ON"
            return "LIGHT_BEDROOM_ON_OK"
        elif cmd == "LIGHT_BEDROOM_OFF":
            self.devices["light_bedroom"] = "OFF"
            return "LIGHT_BEDROOM_OFF_OK"
        elif cmd == "AC_LIVING_ON":
            self.devices["ac_living"] = "ON"
            return "AC_LIVING_ON_OK"
        elif cmd == "AC_LIVING_OFF":
            self.devices["ac_living"] = "OFF"
            return "AC_LIVING_OFF_OK"
        elif cmd.startswith("AC_TEMP_"):
            # AC_TEMP_26
            try:
                temp = parts[2]
